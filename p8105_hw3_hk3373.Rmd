...
In tidying the dataset, the values of precipitation and temperatures were 
divided by 10 since they were in tenths of mm and degrees Celsius respectively. 
...
school equivalent are left skewed indicating more participants with higher age; 
however, the distributions for males with both educations are bimodal. On the 
other hand, the distribution for both female and male with education more than 
high school is right skewed indicating more participants with lower age. 
...
more than high school education. For data of male with high school equivalent 
education, total activity increases until age 40 and declines afterwards. 
...
there is one extreme outlier for activity data of male with more than high 
school education, which makes the range of total activity large for this 
three-panel plot.
